...
export default function Home() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd).replace(/</g, "\\u003c") }} /><Navbar /><main><Hero /><About /><Credentials /><Specialties /><Benefits /><FAQ /><CTA /></main><Footer /></>;
}
